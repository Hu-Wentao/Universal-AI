...
可以看到是去gateway的deposit，從 [**gateway.move**](https://github.com/zeta-chain/localnet/blob/main/src/chains/zetachain/deposit.ts) 中 可以看到
...
-   **ZetaChain 世界**：驗證節點 -> 調用 **ZEVM Gateway (Solidity)** -> 錢被 Mint 出來 -> 轉給 **Universal 合約** 。
