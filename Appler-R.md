...
-   **Windows + WSL + VS Code + Warp** 的这套“黄金开发流”，个人觉得非常好用，win和vs的终端
    
-   学会了在 VS Code 里写代码，去 Warp 里跑命令。
...
-   在运行过程中，发现了一个bug，AI给我跑的代码出现了问题，
    
-   恰恰是我今天刚学的知识点：十六进制字符串是用字符0~9，a~f来显示，发现并改正的AI**语法错误**：把 `hex"..."` 修正为了 `bytes("...")`
